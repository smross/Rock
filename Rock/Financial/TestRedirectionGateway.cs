...
namespace Rock.Financial
{
    ...
    public class TestRedirectionGateway : GatewayComponent, IAutomatedGatewayComponent, IRedirectionGateway
    {
        ...
        IEnumerable<RedirectionGatewayField> _redirectionGatewayFields = null;
        public IEnumerable<RedirectionGatewayField> GatewayFields
        {
            get
            {
                if ( _redirectionGatewayFields == null )
                {
                    _redirectionGatewayFields = BuildRedirectionFields();
                }
                return _redirectionGatewayFields;
            }
        }

        private IEnumerable<RedirectionGatewayField> BuildRedirectionFields()
        {
            var merchantList = new List<KeyValuePair<string, string>>
            {
                new KeyValuePair<string, string>("1", "Test 1"),
                new KeyValuePair<string, string>("2", "Test 2"),
            };

            var fundList = new Dictionary<string, List<KeyValuePair<string, string>>>
            {
                { "1", new List<KeyValuePair<string, string>>
                    {
                        new KeyValuePair<string, string>("1", "Test 1-1"),
                        new KeyValuePair<string, string>("2", "Test 1-2"),
                    }
                },
                { "2", new List<KeyValuePair<string, string>>
                    {
                        new KeyValuePair<string, string>("1", "Test 2-1"),
                        new KeyValuePair<string, string>("2", "Test 2-2"),
                    }
                }
            };

            var merchantField = new RedirectionGatewayField
            {
                Key = "MerchantField",
                DisplayName = "Pushpay Merchant",
                GetItems = ( IEnumerable<string> ids ) =>  merchantList
            };

            var fundField = new RedirectionGatewayField
            {
                Key = "FundField",
                DisplayName = "Pushpay Funds",
                GetItems = ( IEnumerable<string> ids ) => fundList[ids.First()],
                ParentGatewayField = merchantField
            };

            return new List<RedirectionGatewayField>
            {
                merchantField,
                fundField
            };
