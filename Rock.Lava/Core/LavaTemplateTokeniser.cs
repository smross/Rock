...
namespace Rock.Lava
{
    ...
    /// </summary>
    public class LavaTemplateToken
    {
    ...
    public class TokeniseEventArgs : EventArgs
    {
        public string ElementId { get; set; }
    ...
    //{
    //    event EventHandler<TokeniseEventArgs> ElementParsing;
    ...
    public class LavaTemplateTokeniser // : IFluidParser, IFluidParserEx
    {
        ...
        //public bool TryParse( string template, bool stripEmptyLines, out List<LavaTemplateToken> result, out IEnumerable<string> errors )
        //{
