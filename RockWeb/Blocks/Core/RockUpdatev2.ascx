<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RockUpdatev2.ascx.cs" Inherits="RockWeb.Blocks.Core.RockUpdatev2" %>
                    ...
                    <asp:Repeater ID="rptPackageVersions" runat="server" Visible="True"  OnItemDataBound="rptPackageVersions_ItemDataBound" OnItemCommand="rptPackageVersions_ItemCommand">
                            <ItemTemplate>
                                <div id="divPanel" runat="server" class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><asp:Literal runat="server" Text='<%# GetRockVersion( Eval( "SemanticVersion" ) )%>' /></h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-2">
